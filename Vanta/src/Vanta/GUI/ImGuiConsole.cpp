...
namespace Vanta {
    ...
    ImGuiConsole ImGuiConsole::s_Instance;

    void ImGuiConsole::Log(const std::string& message) {
    ...
    void ImGuiConsole::Execute(const std::string& input) {
        Log("# " + input + "\n");
